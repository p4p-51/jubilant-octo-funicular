<template>
  <div class="lecture-view">
    ...
    >
      ...
      sirloin shankle pancetta venison spare ribs. <br />Ball tip tri-tip tongue
      turkey, ham fatback tenderloin pastrami jerky sausage brisket beef
      bresaola pig frankfurter. Pork frankfurter jerky shoulder leberkas
      hamburger. Bresaola ribeye tail kielbasa corned beef pastrami shankle cow
      chuck pancetta flank tenderloin swine. Andouille venison porchetta, jowl
